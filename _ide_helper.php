...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function createOrderFulfillment($orderId, $data)
        {
                        /** @var \Signifly\Shopify\Shopify $instance */
                        return $instance->createOrderFulfillment($orderId, $data);
        }
                    /**
         * 
         *
    ...
    namespace Understand\UnderstandLaravel5\Facades { 
            /**
     * 
     *
     */ 
        class UnderstandFieldProvider {
                    /**
         * 
         *
        ...
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        return $instance->setApp($app);
        }
                    /**
         * Set session store
         *
         * @param \Understand\UnderstandLaravel5\type $service
         * @static 
         */ 
        public static function setSessionStore($service)
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        return $instance->setSessionStore($service);
        }
                    /**
         * Set router
         *
        ...
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        return $instance->setRouter($router);
        }
                    /**
         * Set request
         *
        ...
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        return $instance->setEnvironment($environment);
        }
                    /**
         * 
         *
         * @param \Understand\UnderstandLaravel5\DataCollector $dataCollector
         * @static 
         */ 
        public static function setDataCollector($dataCollector)
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        return $instance->setDataCollector($dataCollector);
        }
                    /**
         ...
         * @static 
         */ 
        public static function extend($name, $provider)
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        $instance->extend($name, $provider);
        }
                    /**
         * Set token provider
         *
         * @param \Understand\UnderstandLaravel5\UniqueProcessIdentifier $tokenProvider
         * @static 
         */ 
        public static function setTokenProvider($tokenProvider)
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        return $instance->setTokenProvider($tokenProvider);
        }
                    /**
         ...
         * @static 
         */ 
        public static function resolveValues($callbacks, $log)
        {
                        /** @var \Understand\UnderstandLaravel5\FieldProvider $instance */
                        return $instance->resolveValues($callbacks, $log);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getJsBundleUrl()
        {
                        /** @var \Understand\UnderstandLaravel5\JsProvider $instance */
                        return $instance->getJsBundleUrl();
        }
                    /**
     ...
     */ 
         ...
         * @static 
         */ 
        public static function log($log, $additional = [], $customFields = [])
        {
                        /** @var \Understand\UnderstandLaravel5\Logger $instance */
                        return $instance->log($log, $additional, $customFields);
        }
                    /**
         * Set handler
         *
         * @param \Understand\UnderstandLaravel5\Handlers\BaseHandler $handler
         * @static 
         */ 
         ...
         * Set field provider
         *
         * @param \Understand\UnderstandLaravel5\FieldProvider $fieldProvider
         * @static 
         */ 
        public static function setFieldProvider($fieldProvider)
        {
                        /** @var \Understand\UnderstandLaravel5\Logger $instance */
                        return $instance->setFieldProvider($fieldProvider);
        }
     ...
     *
     */ 
        class UnderstandExceptionLogger {
                    /**
        ...
        {
                        /** @var \Understand\UnderstandLaravel5\ExceptionLogger $instance */
                        $instance->log($error);
        }
                    /**
         * 
        ...
        {
                        /** @var \Understand\UnderstandLaravel5\ExceptionLogger $instance */
                        $instance->logError($level, $message, $context);
        }
...
namespace  { 
            ...
            class UnderstandFieldProvider extends \Understand\UnderstandLaravel5\Facades\UnderstandFieldProvider {}
            class UnderstandJsProvider extends \Understand\UnderstandLaravel5\Facades\UnderstandJsProvider {}
            class UnderstandLogger extends \Understand\UnderstandLaravel5\Facades\UnderstandLogger {}
            class UnderstandExceptionLogger extends \Understand\UnderstandLaravel5\Facades\UnderstandExceptionLogger {}
