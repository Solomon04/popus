...
const PopupStoreCard: FunctionComponent<Props> = ({ store }) => {
  return (
    <Link
      href='/store'
      className='relative block overflow-hidden rounded-xl bg-[url(https://cdn1.sportngin.com/attachments/photo/ee0f-121282811/Matthew_Hurt_large.JPG)] bg-cover bg-center bg-no-repeat'>
