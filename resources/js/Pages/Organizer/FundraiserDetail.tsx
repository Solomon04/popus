                    ...
                    <div className="max-w-6xl mx-auto px-6 py-16 sm:px-0">
                        ...
                        <div className="py-16 md:flex md:items-start md:justify-between">
                            ...
                            <div className="mt-4 flex flex-shrink-0 md:mt-0 md:ml-4">
                                <button
                                    type="button"
                                    className="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-lg font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                >
                                    Edit
                                </button>
                                <button
                                ...
                                <div className="max-w-md">
                                    ...
                                    <ul className="mt-8 space-y-8">
                                        <li className="flex items-center justify-between">
                                            ...
                                            <p className="text-gray-900 font-semibold">Thursday, October 06, 2022</p>
                                        </li>
                                        <li className="flex items-center justify-between">
                                            <h3 className="text-gray-600 font-medium">End Date</h3>
                                            <p className="text-gray-900 font-semibold">Thursday, October 13, 2022</p>
                                        </li>
                                        <li className="flex items-center justify-between">
                                            <h3 className="text-gray-600 font-medium">Category</h3>
                                            <p className="text-gray-900 font-semibold">Sports & Athletics</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul role="list" className="space-y-1">
                                        {
                                            leaderboard.map((member, place) => (
                                                <li className="py-4" key={place}>
                                                    <Link href="/foo" className="flex items-center space-x-4">
                                                        <h3>{place + 1}</h3>
